...
class StatementController extends Controller
{
    ...
    {
        $data['category'] = KategoriMBTI::all();
        $data['statement'] = StatementMBTI::orderBy('created_at', 'desc')->get();
        return view('hrd/psikotes/MBTI/masterdata/statement/index')->with($data);
    }
    ...
    public function store(Request $request)
    {
        try{
            ...
            return redirect('/statement-mbti')->with('success', 'Data successfully added');
        }
        catch(\Exception $e){
            return redirect('/statement-mbti')->with('failed', 'Please check your data again');
        }
    }
    ...
    {
        $statement =  StatementMBTI::find($id);
