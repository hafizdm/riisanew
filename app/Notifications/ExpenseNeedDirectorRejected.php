...
class ExpenseNeedDirectorRejected extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ...
                    ->line("Mohon maaf permintaan Expense Report anda ditolak oleh Director, mohon untuk periksa dan ajukan kembali pada website riisa.rapidinfrastruktur.com")
