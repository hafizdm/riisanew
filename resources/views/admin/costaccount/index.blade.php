        ...
        <div class="box-body">
            ...
            {{-- sub menu  --}}
             <div style="margin-bottom: 20px">
                <a href="{{url('cost-account/create')}}" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Add Scope of Work</a>
            </div> 
            {{-- end of sub menu  --}}
            ...
            <div class="table-responsive">
                <table id="data-table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                    @foreach($cost_account as $k => $d)
                        <tr>
                            <td>{{$loop->iteration}}</td>
                            <td>{{$d->cost_account}}</td>
                            <td>{{$d->nama_karyawan}}</td>
                            
                            <td>
                                <a href="{{route('editcostaccount',$d->id)}}" class="btn btn-warning btn-xs"><span class='glyphicon glyphicon-pencil'></span></a>
