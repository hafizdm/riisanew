...
<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <li><a href="{{url('')}}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="{{url('divisi')}}">Divisi</a></li>
      </ol>
    </section>
      ...
      <div class="box">
        <div class="box-body">
          ...
          <div style="margin-bottom: 20px">
               <a href="{{url('divisi/create')}}" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span>Tambah Divisi</a>
          </div>
          {{--  end of sub menu  --}}
                ...
                <table id="data-table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    @foreach($divisi as $k => $d)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('editdivisi',$d->id)}}" class="btn btn-warning btn-xs"><span class='glyphicon glyphicon-pencil'></span></a>
