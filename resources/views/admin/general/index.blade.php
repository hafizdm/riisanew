...
<section class="content-header">
    <span class="fonts header-style">
        <b>Data  Working Type</b>
    </span>
    <ol class="breadcrumb">
        <li><a href="{{url('')}}"><i class="fa fa-dashboard"></i> Home</a></li>
    <li class="active"><a href="{{url('general-work')}}">Working Type </a></li>
    </ol>
</section>
        ...
        <div class="box-body">
            ...
            {{-- sub menu  --}}
             <div style="margin-bottom: 20px">
                <a href="{{url('general-work/create')}}" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Tambah Data Working Type </a>
            </div> 
            {{-- end of sub menu  --}}
            ...
            <div class="table-responsive">
                <table id="data-table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        @foreach($general_working_type as $k => $d)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('editgeneral',$d->id)}}" class="btn btn-warning btn-xs"><span class='glyphicon glyphicon-pencil'></span></a>
