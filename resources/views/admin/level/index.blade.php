      ...
      <div class="box">
        <div class="box-body">
          ...
          <div style="margin-bottom: 20px">
               <a href="{{url('level/create')}}" class="btn btn-primary"><span>Tambah Level</span></a>
          </div>
          {{--  end of sub menu  --}}
                ...
                <table id="data-table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('leveledit', $d->id)}}" class="btn btn-warning btn-xs"><span class='glyphicon glyphicon-pencil'></span></a>
...
$(function(){
  ...
  $('#data-table').on('click', '.delete', function (e) {
    ...
    $("#konfirmasi-body").text("Hapus Level?");
  });
