...
<section class="content-header">
    <span class="fonts header-style">
      <b>Data Jabatan-Divisi</b>
    </span>
    <ol class="breadcrumb">
        <li><a href="{{url('')}}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="{{url('posisi-jabatan')}}">Data Posisi Jabatan</a></li>
    </ol>
</section>
    ...
    <div class="box">
        <div class="box-body">
            ...
            <div style="margin-bottom: 20px">
                <a href="{{url('barang/create')}}" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Tambah Data Jabatan-Divisi</a>
            </div>
            {{-- end of sub menu  --}}
                ...
                <table id="data-table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                   ...
                   @foreach($jabatan_divisi as $k => $d)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('editposisi-jabatan',$d->id)}}" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-pencil"></span></a>
