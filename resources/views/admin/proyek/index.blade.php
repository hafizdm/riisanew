...
<section class="content-header">
    <span class="fonts header-style">
        <b>Data Lokasi Proyek</b>
    </span>
    <ol class="breadcrumb">
        <li><a href="{{url('')}}"><i class="fa fa-dashboard"></i> Home</a></li>
    <li class="active"><a href="{{url('proyek')}}">Lokasi Proyek</a></li>
    </ol>
</section>
        ...
        <div class="box-body">
            ...
            {{-- sub menu  --}}
             <div style="margin-bottom: 20px">
                <a href="{{url('proyek/create')}}" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Tambah Data Proyek</a>
            </div> 
            {{-- end of sub menu  --}}
                ...
                <table id="data-table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    @foreach($lokasi_project as $k => $d)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('editproyek',$d->id)}}" class="btn btn-warning btn-xs"><span class='glyphicon glyphicon-pencil'></span></a>
