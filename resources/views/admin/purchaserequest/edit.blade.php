          ...
          <div class="col-xs-12 col-xl-6 col-lg-6">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="javascript:;" class="approved_prf"><i class="fa fa-check" aria-hidden="true" style="color:blue"></i>PO Clear</a></li>
                </ul>
            </div>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      $('.approved_prf').click(function(){
            ...
            $.ajax({
                url: "/prf-list/{{$purchaseRequest->id}}/approve",
                type: 'GET',
        ...
        $('.rejected_prf').click(function(){
            ...
            $.ajax({
                url: "/prf-list/{{$purchaseRequest->id}}/reject",
                type: 'GET',
                success: function(data) {
                    window.location.href = '/prf-list';
                }
