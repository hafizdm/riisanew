        ...
        <div class="box-body">
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-xl-12 col-lg-12 col-12">
              <form role="form" name="formdata" method="post" action="{{route('update_prf_list', $purchaseRequest->id)}}" enctype="multipart/form-data">
                @method('PATCH') 
                @csrf  
                 <div class="form-group">
                 <label for="keterangan">File*</label>
                 <input type="hidden" class="form-control" name="ids" id="ids" value="{{$purchaseRequest->id}}">
               ...
               <a href="{{url('prf-list')}}" class="btn btn-danger">Cancel</a>
