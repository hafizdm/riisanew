...
<section class="content-header">
    ...
    <li class="active"><a href="{{url('resource')}}">Resource </a></li>
    </ol>
</section>
        ...
        <div class="box-body">
            ...
            {{-- sub menu  --}}
             <div style="margin-bottom: 20px">
                <a href="{{url('resource/create')}}" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Tambah Data Resource</a>
            </div> 
            {{-- end of sub menu  --}}
            ...
            <div class="table-responsive">
                <table id="data-table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                    @foreach($resource as $k => $d)
                        <tr>
                            <td>{{$loop->iteration}}</td>
                            <td>{{$d->nama_posisi}}</td>
                            <td>
                                <a href="{{route('editresource',$d->id)}}" class="btn btn-warning btn-xs"><span class='glyphicon glyphicon-pencil'></span></a>
...
$(function(){
  ...
  $('#data-table').on('click', '.delete', function (e) {
    ...
    $("#konfirmasi-body").text("Hapus data resource?");
  });
