          ...
          <div class="row">
            <div class="col-xs-12 col-xl-6 col-lg-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama" name="nama" value="Muhammad Hafizd Elison" placeholder="" readonly >
              </div>

              <div class="form-group">
                <label for="nama">Nik*</label>
                <input type="text" class="form-control" id="nama" name="nama" value="HO20220621" placeholder="" readonly >
              </div>
            ...
            <div class="col-xs-12 col-xl-6 col-lg-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama" name="nama" value="Finance & Support" placeholder="" readonly >
              </div>

              <div class="form-group">
                <label for="nama">Position*</label>
                <input type="text" class="form-control" id="nama" name="nama" value="IT Specialist" placeholder="" readonly >
              </div>
