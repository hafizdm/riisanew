          ...
          <div class="col-xs-12 col-xl-6 col-lg-6">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="javascript:;" class="approved_expense"><i class="fa fa-check" aria-hidden="true" style="color:blue"></i>Approve</a></li>
                    <li><a href="javascript:;" class="rejected_expense"><i class="fa fa-ban" style="color:red" aria-hidden="true"></i>Reject</a></li>
                </ul>
            </div>
          </div>
        </form>
    ...
    $(document).ready(function() {
      ...
      setTimeout(recalculate, 500)
        ...
        $('.approved_expense').click(function(){
            ...
            $.ajax({
                url: "/approval-expense/{{$expenseReport->id}}/approve",
                type: 'GET',
        ...
        $('.rejected_expense').click(function(){
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
            ...
            $.ajax({
                url: "/approval-expense/{{$expenseReport->id}}/reject",
                type: 'GET',
                success: function(data) {
                    window.location.href = '/approval-expense';
                }
