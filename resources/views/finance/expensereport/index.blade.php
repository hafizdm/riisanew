...
<!-- Content Header (Page header) -->
    ...
    <br>
      ...
      <li class="active"><a href="#"></a>Expense Report Request</li>
      </ol>
    </section>
                    ...
                    @foreach($expenseReport as $d)
                      ...
                      @endphp
                        <tr>
                            ...
                            <td>
                                <a href="{{route('upload-expense',$d->id)}}" class="btn btn-default btn-xs" style="color: dodgerblue;">Upload file</span></a>
                            ...
                            <td>
                                <a href="{{url('pdf-expense',$d->id)}}" class="btn btn-primary btn-xs"><span class='glyphicon glyphicon-print'></span></a>  
                                <a href="{{route('edit_expense_payment',$d->id)}}" class="btn btn-warning btn-xs"><span class='glyphicon glyphicon-pencil'></span></a>  
