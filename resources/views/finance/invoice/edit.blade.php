        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title fonts"><b>Upload Invoice</b></h3>
                </div>
                <br>
                <div class="box-body">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                        <form role="form" name="formdata" method="post" enctype="multipart/form-data" action="{{route('updatebuktiinvoice', $request_barang->id)}}">
                            @method('PATCH') 
                            @csrf
                        <div class="row">
                            <div class="col-lg-6 col-xs-12 col-xl-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="nama_proyek" type="text" class="form-control" id="nama_proyek" value="{{$request_barang->lokasiProyek->nama}}" readonly>
                            ...
                            <div class="col-lg-6 col-xs-12 col-xl-6">
                                ...
                                <div class="form-group">
                                    <label for="updated_ceo_po_by">Disetujui Oleh</label>
                                    <input name="updated_ceo_po_by" type="text" class="form-control" id="updated_pm_po_by" value="{{$request_barang->updated_pm_po_by  != "" ? $request_barang->updated_pm_po_by : $request_barang->updated_vp_po_by }}" readonly>
                                    <span class="help-block" >{{ $errors->first('updated_ceo_po_by') }} </span>
                                </div>
        
                                <div class="form-group">
                                    <label for="upload_invoice">Upload Bukti Invoice</label>
                                ...
                                <button type="submit" class="btn btn-primary">Simpan</button>
                                  <a href="{{url("list-invoice")}}" class="btn btn-danger">Batal</a>
                        </div>
                        </div>
                        </form>
                        </div>
