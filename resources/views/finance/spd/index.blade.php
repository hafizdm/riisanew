    ...
    <div class="box">
      <div class="box-body">
          <div style="margin-bottom: 20px">
              <a href="list-spd-report" class="btn btn-warning">Report SPD
              ...
              <table id="data-table" class="table table-striped table-bordered" cellspacing="0" width="100%" style="white-space: nowrap !important;">
                  ...
                  @endphp
                      ...
                      <tr>
                          ...
                          <td>
                            @if($d->spdApproval->status == 0 || $d->spdApproval->hr_status == 0)
                            <span class="label label-warning">Request Process</span>
                            @elseif($d->spdApproval->status == 2 || $d->spdApproval->hr_status == 2)
                          ...
                          <td>
                            @if($d->spdApproval && $d->spdApproval->finance_status == 0)
                                    <span></span>
                                @elseif($d->spdApproval && $d->spdApproval->finance_status == 1)
                                    <a href="{{route('upload_finance_spd',$d->id)}}" class="btn btn-default btn-xs" style="color: dodgerblue;">Upload file</span></a>
                          ...
                          <td>
                            ...
                            <a href="{{route('edit_payment_spd',$d->id)}}" class="btn btn-warning btn-xs"><span class='glyphicon glyphicon-pencil'></span></a>
                          </td>
                      </tr>
                      @endforeach
                  </tbody>
