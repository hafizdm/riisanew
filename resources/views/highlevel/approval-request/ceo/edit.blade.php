...
<section class="content">
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                        <form role="form" name="formdata" method="post" action="{{route('updateapprovalceo', $approval->id)}}">
                        @method('PATCH') 
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                ...
                                <button type="submit" class="btn btn-primary">Simpan</button>
                                  <a href="{{url("approvalCEO")}}" class="btn btn-danger">Batal</a>
                        </div>
                        </div>
                        </form>
                        </div>
    ...
    <script type="text/javascript">
        document.getElementById("status_pengajuan").onchange = function() {
            ...
            if(document.getElementById("status_pengajuan").value == 3 || document.getElementById("status_pengajuan").value == 4){ 
