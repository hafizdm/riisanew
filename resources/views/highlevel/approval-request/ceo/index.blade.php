...
<section class="content-header">
    <span class="fonts" style="font-size:20px">
       ...
       <li class="active"><a href="{{url('approvalCEO')}}">Approval Request</a></li>
       </ol>
</section>
                ...
                <table id="data-table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    @foreach($request_barang as $k => $d)
                        <tr>
                            ...
                            @endif
                            <td>
                                <a href="{{route('editapprovalceo',$d->id)}}" class="btn btn-info btn-xs"><span class='glyphicon glyphicon-pencil'></span></a>
