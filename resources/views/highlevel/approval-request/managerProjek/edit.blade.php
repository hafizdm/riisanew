        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                        <form role="form" name="formdata" method="post" action="{{route('updateapprovalmanagerprojek', $approval->id)}}">
                        @method('PATCH') 
                        @csrf
                        <div class="row">
                            <div class="col-lg-6 col-xs-12 col-xl-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="nama_proyek" type="text" class="form-control" id="nama_proyek" value="{{$approval->lokasiProyek->nama_proyek}}" readonly>
