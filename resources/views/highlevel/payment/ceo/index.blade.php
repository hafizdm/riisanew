...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{url('payment-ceo')}}">Approval Payment</a></li>
    </ol>
</section>
                ...
                <table id="data-table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    @foreach($request_barang as $k => $d)
                        <tr>
                            ...
                            <!--<td><a href="{{url('uploads/invoice/'.$d->upload_invoice)}}" target="_blank">Lihat File Invoice</td>-->

                            @if($d->status_pengajuan == 1 && $d->status_PO == 2 && $d->status_paid == 2)
                                <td>
                                <span class='label label-danger'>UNPAID</span>
                                </td>
                            @endif
                            <td>
                                <a href="{{route('editapprovalceo-payment',$d->id)}}" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i> </span></a>
                            </td>
