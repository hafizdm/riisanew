...
<section class="content-header">
    <h1>
     Approval Payment
        <small> - VP Finance & Support</small> 
    </h1>
    <ol class="breadcrumb">
                ...
                <table id="data-table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    @foreach($request_barang as $k => $d)
                        <tr>
                            ...
                            <td>{{$d->keterangan}}</td>
                            @if($d->status_pengajuan == 3 && $d->status_PO == 5 && $d->status_paid == 2)
                                <td>
                            ...
                            @endif
                            <td>
                                <a href="{{route('editapprovalvp-payment',$d->id)}}" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i> </span></a>
                            </td>
