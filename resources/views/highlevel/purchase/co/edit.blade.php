...
<section class="content">
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                        <form role="form" name="formdata" method="post" action="{{route('updateapprovalco-po', $approval->id)}}">
                        @method('PATCH') 
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                ...
                                <a href="{{url("po")}}" class="btn btn-danger">Batal</a>
                        </div>
                        </div>
                        </form>
                        </div>
    ...
    <script type="text/javascript">
        document.getElementById("status_PO").onchange = function() {
            document.querySelector("#inputKeterangan").innerHTML = '';
            if(document.getElementById("status_PO").value == 1 || document.getElementById("status_PO").value == 4){ 
                var input = document.createElement("TEXTAREA");
                input.required = true;
                input.name = 'keterangan_by_cc';
                input.className = 'form-control';
                input.placeholder = 'Tambahkan Keterangan';
                input.maxLength = "1000";
                input.cols = "80";
                input.rows = "5";      
                document.getElementById("inputKeterangan").append(input);
