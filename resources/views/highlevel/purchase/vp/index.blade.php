...
<section class="content-header">
    {{-- <span class="fonts" style="font-size:20px">
       ...
       <li class="active"><a href="{{url('po-CEO')}}">Approval Purchased Order</a></li>
       </ol>
</section>
                ...
                <table id="data-table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    @foreach($request_barang as $k => $d)
                        <tr>
                            ...
                            @if($d->status_pengajuan == 1 && $d->status_PO == 0 || $d->status_PO == 1 || $d->status_PO == 2 || $d->status_PO == 2)
                            <td>
                            ...
                            @endif
                            <td>
                                <a href="{{route('editapprovalvp-po',$d->id)}}" class="btn btn-info btn-xs"><span class='glyphicon glyphicon-pencil'></span></a>
