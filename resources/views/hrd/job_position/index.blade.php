...
<section class="content-header">
    ...
    <li class="active"><a href="{{url('cost-account')}}">Job position </a></li>
    </ol>
</section>
        ...
        <div class="box-body">
            ...
            {{-- sub menu  --}}
             <div style="margin-bottom: 20px">
                <a href="{{url('posisi-kerja/create')}}" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Add Job Position</a>
            </div> 
            {{-- end of sub menu  --}}
            ...
            <div class="table-responsive">
                <table id="data-table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        @foreach ($job_position as $k => $d)
                            <tr>
                                <td>{{$k + 1}}</td>
                                <td>{{$d->nama}}</td>
                                <td>
                                    <a href="{{route('editposisikerja',$d->id)}}" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-pencil"></span></a>
