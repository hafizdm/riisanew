...
<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <li class="active"><a href="{{url('kategori-disc')}}">Category</a></li>
        </ol>
    </section>
        ...
        <div class="box">
            <div class="box-body">
                ...
                <div class="table-responsive">
                    <table id="tb_category_disc" class="table table-bordered table-striped" cellspacing="0" width="100%">
                        <thead>
                            <tr>
    ...
    @include('hrd.psikotes.DISC.masterdata.kategori.create')
    @include('hrd.psikotes.DISC.masterdata.kategori.edit')
...
<script>
    $(function(){
        var mainTable = $('#tb_category_disc').DataTable();
        var selectedRow;
        $.ajaxSetup({
            headers: {
        ...
        $('#tb_category_disc').on('click', '.delete', function (e) {
            e.preventDefault();
        ...
        // edit data kategori 
        $('#tb_category_disc').on('click', '#editCategory_', function(e){
            e.preventDefault();
