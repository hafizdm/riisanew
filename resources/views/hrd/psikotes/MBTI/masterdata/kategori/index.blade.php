...
<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <li class="active"><a href="{{url('kategori-mbti')}}">Category</a></li>
        </ol>
    </section>
        ...
        <div class="box">
            <div class="box-body">
                ...
                <div class="table-responsive">
                    <table id="tb_category_mbti" class="table table-bordered table-striped" cellspacing="0" width="100%">
                        <thead>
                            <tr>
    ...
    @include('hrd.psikotes.MBTI.masterdata.kategori.create')
    @include('hrd.psikotes.MBTI.masterdata.kategori.edit')
...
<script>
    $(function(){
        var mainTable = $('#tb_category_mbti').DataTable();
        var selectedRow;
        $.ajaxSetup({
            headers: {
        ...
        $('#tb_category_mbti').on('click', '.delete', function (e) {
            e.preventDefault();
        ...
        // edit data kategori 
        $('#tb_category_mbti').on('click', '#editCategory_', function(e){
            e.preventDefault();

            var id = $(this).data('id');
            console.log("id>>>", id);

            $.get('kategori-mbti/'+id , function(data){
