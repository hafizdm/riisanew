...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <span class="fonts header-style">
        <b>MBTI Score Report </b>
    </span>
      <ol class="breadcrumb">
      <li><a href="{{url('')}}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
      <li class="active"><a href="{{url('report-mbti')}}">Report</a></li>
      </ol>
    </section>
                    ...
                    <tbody>
                        @foreach ($candidate as $item)
                            <tr>
                                ...
                                <td>
                                    <center>
                                    <a href="{{route('show-report-mbti',$item->id)}}"><i class="fa fa-eye fa-1x"></i></a>
                                    </center>
                                </td>
                            </tr>
                        @endforeach
