...
<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <li class="active"><a href="{{url('kategori-msdt')}}">Category</a></li>
        </ol>
    </section>
        ...
        <div class="box">
            <div class="box-body">
                ...
                <div class="table-responsive">
                    <table id="tb_category_msdt" class="table table-bordered table-striped" cellspacing="0" width="100%">
                        <thead>
                            <tr>
    ...
    @include('hrd.psikotes.MSDT.masterdata.kategori.create')
    @include('hrd.psikotes.MSDT.masterdata.kategori.edit')
...
<script>
    $(function(){
        var mainTable = $('#tb_category_msdt').DataTable();
        var selectedRow;
        $.ajaxSetup({
            headers: {
        ...
        $('#tb_category_msdt').on('click', '.delete', function (e) {
            e.preventDefault();
        ...
        // edit data kategori 
        $('#tb_category_msdt').on('click', '#editCategory_', function(e){
            e.preventDefault();

            var id = $(this).data('id');
            console.log("id>>>", id);

            $.get('kategori-disc/'+id , function(data){
