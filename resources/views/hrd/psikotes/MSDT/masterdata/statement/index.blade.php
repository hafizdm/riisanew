...
<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <li class="active"><a href="{{url('statement-msdt')}}">Statement</a></li>
        </ol>
    </section>
        ...
        <div class="box">
            <div class="box-body">
                ...
                <div class="table-responsive">
                    <table id="tb_statement_msdt" class="table table-bordered table-striped" cellspacing="0" width="100%">
                        <thead>
                            <tr>
    ...
    @include('hrd.psikotes.MSDT.masterdata.statement.create')
    @include('hrd.psikotes.MSDT.masterdata.statement.edit')
...
<script>
    $('.select2').select2();
    $(function(){
        var mainTable = $('#tb_statement_msdt').DataTable();
        var selectedRow;
        $.ajaxSetup({
            headers: {
        ...
        $('#tb_statement_msdt').on('click', '.delete', function (e) {
            e.preventDefault();
        ...
        // edit data kategori 
        $('#tb_statement_msdt').on('click', '#editStatement_', function(e){
            e.preventDefault();

            var id = $(this).data('id');
            console.log("id>>>", id);

            $.get('statement-msdt/'+id , function(data){
