...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <span class="fonts header-style">
        <b>PAPIKOSTICK Score Report </b>
    </span>
      <ol class="breadcrumb">
      <li><a href="{{url('')}}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
      <li class="active"><a href="{{url('report-papikostik')}}">Report</a></li>
      </ol>
    </section>
                    ...
                    <tbody>
                        @foreach ($candidate as $item)
                            <tr>
                                ...
                                <td>
                                    <center>
                                    <a href="{{route('show-report-papikostik',$item->id)}}"><i class="fa fa-eye fa-1x"></i></a>
                                    </center>
                                </td>
                            </tr>
                        @endforeach
