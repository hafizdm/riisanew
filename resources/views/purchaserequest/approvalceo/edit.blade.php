          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-xl-3 col-lg-3">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="is_urgent" id="is_urgent" style="width: 100%;"disabled >
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      $('.approved_prf').click(function(){
            ...
            $.ajax({
                url: "/prf-approvalceo/{{$purchaseRequest->id}}/approve",
                type: 'GET',
                success: function(data) {
                    window.location.href = '/prf-approvalceo';
                }
            });
        });
        ...
        $('.rejected_prf').click(function(){
            ...
            $.ajax({
                url: "/prf-approvalceo/{{$purchaseRequest->id}}/reject",
                type: 'GET',
                success: function(data) {
                    window.location.href = '/prf-approvalceo';
                }
