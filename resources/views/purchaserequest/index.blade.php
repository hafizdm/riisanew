      ...
      <div class="box">
        <div class="box-body">
          <div style="margin-bottom: 20px">
            <a href="pengajuan-prf/create" class="btn btn-primary">Add PRF</a>
          </div>
                        ...
                        @endphp
                          <tr>
                              ...
                              <td>
                                  ...
                                  @elseif ($d->status == 4)
                                  <span class="label label-primary">PO Prepared</span>
                                  @elseif ($d->status == 5)
                              ...
                              <td>
                                ...
                                @elseif ($d->status == 5)
                                    PRF Complete
                                @elseif ($d->status == 1 || $d->status == 3)
                                    Request Rejected by {{$d->approverEmployee->nama}}
                                @else
                                    Waiting Approval By {{$d->approverEmployee->nama}}
                                @endif
                              </td>
                              <td>                                 
                              ...
                              <td>
                                  ...
                                  <a href="{{route('edit_pengajuan_prf',$d->id)}}" class="btn btn-warning btn-xs"><span class='glyphicon glyphicon-pencil'></span></a>  
                                  @if ($d->status == 0 )
