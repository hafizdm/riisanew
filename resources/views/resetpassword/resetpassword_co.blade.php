        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <form role="form" name="formdata"  method="post" action="{{route('updatepassword-co', $reset->id)}}">
                                @method('PATCH') 
                                @csrf
                            ...
                            <a href="{{url("ganti-password-co")}}/{{Auth::user()->id}}" class="btn btn-danger">Batal</a>
                            </form>
                        </div>
                    </div>
                </div>
