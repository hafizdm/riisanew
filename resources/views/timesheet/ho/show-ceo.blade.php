...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{url('all-time-sheet')}}">Persentase kerja</a></li>
    </ol>
</section>
    ...
    <div class="row">
        <div class="col-md-5">
            <div class="box box-default">
                ...
                <form role="form" name="formdata" method="post" action="{{route('filter-ho', $get_id)}}">
                    {{csrf_field()}}
                    <div class="box-body">
                ...
                <div class="box-footer">
                    <a href="{{url('all-time-sheet')}}/{{$get_id}}" class="btn btn-default"><i class="fa fa-refresh"></i> Refresh</a>
