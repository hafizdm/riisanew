            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#approvals" data-toggle="tab"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Approval Time Sheet</a></li>
                        <li><a href="#daily_report" data-toggle="tab"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> &nbsp; Daily Report</a></li>
                        <li><a href="#man_hours" data-toggle="tab"> <i class="fa fa-clock-o" aria-hidden="true"></i>&nbsp; List Man Hours</a></li>
                    </ul>
                                            ...
                                            <tr>
                                                  ...
                                                  <td>
                                                      <center>
                                                        ...
                                                        <!--<a href="{{route('edit-status-timesheet-project',$d->id)}}" class="btn btn-default btn-xs" style="color: dodgerblue;"><i class="fa fa-edit"></i>Ubah Status</a>-->
                                                  </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                                ...
                                                <div class="col-md-6 col-xs-12 col-lg-6">
                                                    <div class="box box-default collapsed-box box-solid">
                                                        ...
                                                        <div class="box-body">
                                                            ...
                                                            <?php
                                                                $detail_resource = TimeSheetUser::whereBetween('tanggal_kerja',[$tgl_approved, $tgl_now])
                                                                                    ->where('status',1)
                                                                                    ->where('cost_account_id',3)
                                                                                    ->where('project_id', $p->lokasi_id)
...
google.charts.load('current', {
  callback: function () {
    ...
    var data = google.visualization.arrayToDataTable([
        ['Role', 'Total Hours'],
           @php 
           foreach($chart_project as $cp) {
                echo "['".$cp->resourceName2->nama_posisi."',".$cp->total_man_hours."],";
                }
           @endphp
    ]);
