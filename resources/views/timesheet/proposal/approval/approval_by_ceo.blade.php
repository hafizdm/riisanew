        ...
        <div class="col-xs-12 col-xl-10 col-lg-10">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title fonts"><b>Approval Proposal</b></h3>
                </div>
                <br>
                <div class="box-body">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-xs-12 col-xl-12">
                        <form role="form" name="formdata" method="post" action="{{route('update-approval-proposal', $ubah_status->id)}}">
                            @method('PATCH') 
                            @csrf
                        <div class="row">
                            <div class="col-lg-12 col-xs-12 col-xl-12">
                                ...
                                <div class="form-group">
                                    <label>Lokasi</label>
                                    <input type="text" class="form-control" value="{{$ubah_status->getLokasi->lokasi}}" readonly>
                                </div>
