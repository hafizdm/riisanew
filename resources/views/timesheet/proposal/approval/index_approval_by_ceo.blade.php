...
<section class="content-header">
    <span class="fonts header-style">
        <b>List Pengajuan Proposal dan Project</b>
      </span>
    <ol class="breadcrumb">
        <li><a href="{{url('')}}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="{{url('approval-timesheet-ceo')}}">proposal dan project</a></li>
    </ol>
</section>
...
$('#btnSelectAll').on('click',function (e) {
    ...
    $("#modal-konfirmasi").find("#confirm-delete").data("id", id);
